### Terracotta Server 5.8.0 Docker images
...
You can re use the same docker-compose.yml file :
    ...
    i88gj5reok4x  terracotta_client.1        terracotta/sample-ehcache-client:5.8.0  moby  Running        Running 23 seconds ago
    hrzyj5z2uwkh  terracotta_terracotta-2.1  terracotta/terracotta-server-oss:5.8.0  moby  Running        Running 24 seconds ago
    944cftq26cis  terracotta_terracotta-1.1  terracotta/terracotta-server-oss:5.8.0  moby  Running        Running 25 seconds ago
